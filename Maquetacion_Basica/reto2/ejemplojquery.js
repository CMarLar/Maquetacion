...
jQuery(() => {
    ...
    $("#append").on("click", ()=>{
        ...
        // $("#parrafo3").append('<button id="nuevo" class="btn btn-warning" onclick="nueva()">Boton nuevo</button> <h1>Helloooo</h1> ');
        $("#parrafo3").html('<button id="nuevo" class="btn btn-warning" onclick="nueva()">Boton nuevo</button> <h1>Helloooo</h1> ');
